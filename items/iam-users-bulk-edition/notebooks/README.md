...
"philipp.mayer@example.com" | "present" | `true` | "pmayer" | "Philipp"  | "Mayer" | "ewc-iam-user:ewc-jhub-lab-f54924:ewc-jhub-lab-cfe2f3" | "Adds/updates user with optional default overrides for `username`, `first_name`, `last_name` and `roles` (two roles **separated by colon**)."  |
